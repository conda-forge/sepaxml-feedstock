...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sepaxml-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14019&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sepaxml-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sepaxml` can be installed with:

```
conda install sepaxml
```

It is possible to list all of the versions of `sepaxml` available on your platform with:
